...
{//9
  story: "On te propose un objet au théâtre, est ce que tu le prends ?",
  options: [{
      text: "Oui",
      nextState: 10,
      onChoose: () => {
        addItem("theatre quest object", inventory, () => updateInventory(inventory, inventoryElement));
      },
    },
    {
      text: "Non",
...
{//10
  story: "tu as accepté l'objet donné au théâtre. Vous partez pour le Chat noir mais Pierre doit aller faire un truc avant alors tu y vas tout seul",
  options: [{
      text: "Ok",
      nextState: 13
    },
